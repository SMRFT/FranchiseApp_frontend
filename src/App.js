...
import MaterialIndent from './Components/MaterialIndent';
    ...
    <div style={{ display: 'flex', minHeight: '100vh', width: '100vw', overflowX: 'hidden' }}>
      ...
      <div className="main-content-wrapper">
        <Routes>
          ...
          <Route path="/MaterialIndent" element={<MaterialIndent />} />
          <Route path="/MaterialRequisition" element={<MaterialIndent />} />
        </Routes>
      </div>
    </div>
  );
