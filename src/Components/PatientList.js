...
const Container = styled.div`
  ...
  background: linear-gradient(135deg, #e8f6f9, #d0edf4);
  min-height: 100vh;
...
const Header = styled.div`
  ...
  padding: 2rem;
  margin-bottom: 2rem;
  box-shadow: 0 10px 30px rgba(75, 158, 176, 0.15);
  border: 1px solid rgba(111, 177, 196, 0.25);
...
const DateInput = styled.input`
  ...
  &:focus {
    outline: none;
    border-color: #4B9EB0;
    box-shadow: 0 0 0 3px rgba(75, 158, 176, 0.15);
  }
...
const Button = styled.button`
  ...
  box-shadow: ${props => props.$variant === 'primary'
    ? '0 4px 15px rgba(75, 158, 176, 0.35)'
    : '0 4px 15px rgba(245, 158, 11, 0.3)'};
  
  &:hover {
    transform: translateY(-2px);
    background: ${props => props.$variant === 'primary'
    ? 'linear-gradient(135deg, rgb(85,156,175), rgb(38,136,158))'
    : 'linear-gradient(135deg, #d97706, #b45309)'};
    box-shadow: ${props => props.$variant === 'primary'
    ? '0 6px 20px rgba(75, 158, 176, 0.45)'
...
const TableCard = styled.div`
  ...
  border-radius: 20px;
  box-shadow: 0 10px 30px rgba(75, 158, 176, 0.15);
  border: 1px solid rgba(111, 177, 196, 0.2);
  overflow: hidden;
...
const TH = styled.th`
  ...
  &:hover {
    background: ${props => props.$sortable ? 'rgba(255, 255, 255, 0.12)' : 'transparent'} !important;
  }
`
...
const TR = styled.tr`
  ...
  &:hover {
    background: rgba(111, 177, 196, 0.08);
  }
...
const MobileCard = styled.div`
  ...
  padding: 1.25rem;
  margin-bottom: 1rem;
  box-shadow: 0 4px 12px rgba(75, 158, 176, 0.1);
  border: 2px solid #b2dce8;
  transition: all 0.3s ease;
  
  &:hover {
    border-color: #4B9EB0;
    box-shadow: 0 6px 20px rgba(75, 158, 176, 0.2);
  }
`
...
const TestItem = styled.div`
  ...
  align-items: center;
  padding: 0.75rem;
  background: ${props => props.$cancelled ? '#fee2e2' : '#f0f9fb'};
  border-radius: 8px;
  border-left: 3px solid ${props => props.$cancelled ? '#ef4444' : '#4B9EB0'};
  font-size: 0.85rem;
  transition: all 0.2s ease;
  flex-wrap: wrap;
  gap: 0.5rem;
  ...
  &:hover {
    ...
    box-shadow: 0 2px 8px rgba(75, 158, 176, 0.15);
  }
...
const Badge = styled.span`
  ...
  ${props => props.$type === 'barcode' && `
    background: linear-gradient(135deg, #4B9EB0, #2d7d8f);
    color: white;
    font-family: 'Courier New', monospace;
  `}
...
const PageButton = styled.button`
  ...
  color: ${props => props.$active ? 'white' : '#4B9EB0'} !important;
  border-radius: 10px;
  font-size: 0.875rem;
  font-weight: 600;
  cursor: pointer;
  ...
  &:hover:not(:disabled) {
    background: ${props => props.$active ? 'linear-gradient(135deg, #6FB1C4, #4B9EB0)' : '#e8f6f9'};
    border-color: #4B9EB0;
  }
